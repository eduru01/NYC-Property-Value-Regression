...
This project investigates which neighborhood features most strongly influence residential property values across New York City, using multiple linear regression and borough-specific models.  

The goal is to understand how amenities and socioeconomic characteristics drive variation in housing prices and how these relationships differ between the Bronx, Brooklyn, Manhattan, Queens, and Staten Island.  
...
New York State Department of Agriculture & Markets. Retail Food Stores.  
...
https://data.gis.ny.gov/datasets/sharegisny::schools-k-12  
...
Social Explorer. ACS 5-Year Estimates, U.S. Census Bureau.  
https://www.socialexplorer.com  

MTA Subway Stations (GSA).  
...
- **Manhattan:** Subway stations ↑, income ↑, new businesses ↓  
...
- Include zoning, school quality, environmental amenities  
